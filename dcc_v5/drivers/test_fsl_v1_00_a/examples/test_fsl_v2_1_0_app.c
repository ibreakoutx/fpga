//////////////////////////////////////////////////////////////////////////////
// Filename:          C:\work\fpga\dcc_v2p\drivers/test_fsl_v1_00_a/examples/test_fsl_v2_1_0_app.c
// Version:           1.00.a
// Description:       test_fsl (new FSL core) Driver Example File
...
#define WRITE_TEST_FSL_0(val)  write_into_fsl(val, XPAR_FSL_TEST_FSL_0_INPUT_SLOT_ID)
#define READ_TEST_FSL_0(val)  read_from_fsl(val, XPAR_FSL_TEST_FSL_0_OUTPUT_SLOT_ID)
       ...
       )
{
   ...
   for (i=0; i<8; i++)
   {
      WRITE_TEST_FSL_0(input_0[i]);
   }

   //Start reading from the FSL bus
   for (i=0; i<8; i++)
   {
      READ_TEST_FSL_0(output_0[i]);
   }
}
...
main()
{
	 ...
	 test_fsl(
		 XPAR_FSL_TEST_FSL_0_INPUT_SLOT_ID,
		 XPAR_FSL_TEST_FSL_0_OUTPUT_SLOT_ID,
		 input_0,      
		 output_0       
		 );
