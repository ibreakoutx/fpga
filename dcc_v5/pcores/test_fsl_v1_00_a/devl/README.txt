...
File Summary
  ...
  - HDL source -
  C:\work\fpga\dcc_v2p\pcores\test_fsl_v1_00_a\hdl\vhdl
  top level      : test_fsl.vhd

  - XPS interface -
  C:\work\fpga\dcc_v2p\pcores\test_fsl_v1_00_a\data
  mpd            : test_fsl_v2_1_0.mpd
  pao            : test_fsl_v2_1_0.pao

  - ISE project -
  C:\work\fpga\dcc_v2p\pcores\test_fsl_v1_00_a\devl\projnav
  ise project    : test_fsl.npl
  cli command    : test_fsl.cli


  - XST synthesis -
  C:\work\fpga\dcc_v2p\pcores\test_fsl_v1_00_a\devl\synthesis
  xst script     : test_fsl_xst.scr
  xst project    : test_fsl_xst.prj

  - Misc file -
  C:\work\fpga\dcc_v2p\pcores\test_fsl_v1_00_a\devl
  help           : README.txt
  option         : ipwiz.opt
  log            : ipwiz.log

  - Driver source -
  C:\work\fpga\dcc_v2p\drivers\test_fsl_v1_00_a\src
  makefile       : Makefile
  header         : test_fsl.h
  source         : test_fsl.c

  - Driver interface -
  C:\work\fpga\dcc_v2p\drivers\test_fsl_v1_00_a\data
  mdd            : test_fsl_v2_1_0.mdd
  tcl            : test_fsl_v2_1_0.tcl
...
written into src/test_fsl.c in the Driver Directory.
...
implemented in hdl/vhdl/test_fsl.vhd in the Core Directory.
