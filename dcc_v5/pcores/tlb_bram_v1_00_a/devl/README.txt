...
File Summary
  ...
  - HDL source -
  C:\work\fpga\dcc_v2p\pcores\tlb_bram_v1_00_a\hdl\vhdl
  top level      : tlb_bram.vhd

  - XPS interface -
  C:\work\fpga\dcc_v2p\pcores\tlb_bram_v1_00_a\data
  mpd            : tlb_bram_v2_1_0.mpd
  pao            : tlb_bram_v2_1_0.pao

  - ISE project -
  C:\work\fpga\dcc_v2p\pcores\tlb_bram_v1_00_a\devl\projnav
  ise project    : tlb_bram.npl
  cli command    : tlb_bram.cli


  - XST synthesis -
  C:\work\fpga\dcc_v2p\pcores\tlb_bram_v1_00_a\devl\synthesis
  xst script     : tlb_bram_xst.scr
  xst project    : tlb_bram_xst.prj

  - Misc file -
  C:\work\fpga\dcc_v2p\pcores\tlb_bram_v1_00_a\devl
  help           : README.txt
  option         : ipwiz.opt
  log            : ipwiz.log

  - Driver source -
  C:\work\fpga\dcc_v2p\drivers\tlb_bram_v1_00_a\src
  makefile       : Makefile
  header         : tlb_bram.h
  source         : tlb_bram.c

  - Driver interface -
  C:\work\fpga\dcc_v2p\drivers\tlb_bram_v1_00_a\data
  mdd            : tlb_bram_v2_1_0.mdd
  tcl            : tlb_bram_v2_1_0.tcl
...
written into src/tlb_bram.c in the Driver Directory.
...
implemented in hdl/vhdl/tlb_bram.vhd in the Core Directory.
