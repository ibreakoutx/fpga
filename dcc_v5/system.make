...
encrypt_app_program: $(ENCRYPT_APP_OUTPUT) 

$(ENCRYPT_APP_OUTPUT) : $(ENCRYPT_APP_SOURCES) $(ENCRYPT_APP_HEADERS) $(ENCRYPT_APP_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/encrypt_app_compiler.opt
	@mkdir -p $(ENCRYPT_APP_OUTPUT_DIR) 
	$(ENCRYPT_APP_CC) $(ENCRYPT_APP_CC_OPT) $(ENCRYPT_APP_SOURCES) -o $(ENCRYPT_APP_OUTPUT) \
	$(ENCRYPT_APP_OTHER_CC_FLAGS) $(ENCRYPT_APP_INCLUDES) $(ENCRYPT_APP_LIBPATH) \
	$(ENCRYPT_APP_CFLAGS) $(ENCRYPT_APP_LFLAGS) 
	$(ENCRYPT_APP_CC_SIZE) $(ENCRYPT_APP_OUTPUT) 
	@echo ""

encrypt_app_programclean:
	rm -f $(ENCRYPT_APP_OUTPUT) 
