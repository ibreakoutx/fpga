...
//----------------------------------------------------------------------------
  ...
  assign
   ...
   wire [1:0]  reg_select = slv_reg3[62:63];
    ...
    begin: slave_reg_write_proc
      ...
      if ( bus2ip_reset == 1 )
	    ...
	    slv_reg3 <= bus2ip_data;
		  ...
		  if ( slv_reg3[33] )//Read
		    case( reg_select)
		      2'd0: slv_reg2 <= global_key[127:94];
		      2'd1: slv_reg2 <= global_key[93:64] ;
		      2'd2: slv_reg2 <= global_key[63:32] ;
		      2'd3: slv_reg2 <= global_key[31:0]  ;	    
   ...
   always @(posedge bus2ip_clk)
     if (bus2ip_reset == 1)
	  ...
	  if ( slv_reg3[32] )//Write
	    case(reg_select)
	      2'd0: global_key[127:96] <= slv_reg2[32:63] ;
	      2'd1: global_key[95:64] <= slv_reg2[32:63] ;
	      2'd2: global_key[63:32] <= slv_reg2[32:63] ;
	      2'd3: global_key[31:0] <= slv_reg2[32:63] ;	    
	    endcase // case ( slv_reg1[16:31] )
       end
